...
const InputBox = ({ label, amount, currency, onAmountChange, currencyOptions, onCurrencyChange }) => {
    return (
        <div className='bg-white p-4 flex flex-col gap-3 rounded-md w-full'>
            ...
            <div className='flex justify-between items-center'>
                ...
                <select value={currency} className="select bg-white border-gray-200 pe-0 text-black" onChange={(e) => {onCurrencyChange(e.target.value)}}>
                    {
