    ...
    return (
        <div className='bg-white p-4 flex flex-col gap-3 rounded-md'>
            ...
            <div className='flex justify-between items-center'>
                <input type="number" placeholder="Amount" id='amount' className="input px-0 bg-white text-black placeholder:text-gray-400 text-lg outline-0 shadow-none border-0" value={amount} onChange={(e) => {onAmountChange((e.target.value))}}/>
                <div className="dropdown dropdown-end" >
                    <div tabIndex="0" role="button" className="btn text-black bg-neutral-200 border-0 shadow-none px-5">{currency}</div>
